"""
Student Chatbot API Routes
Placement Preparation AI Assistant endpoints for students
"""
...
# Initialize router
router = APIRouter(prefix="/api/student/chatbot", tags=["Student Chatbot"])
